...
const movie =
    {
        ...
        'releaseYear' : '2013',
        'summary' : 'Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit sed.',
        ...
        <div className="content">
            <div className="row">
                ...
                <div className="col-md-6">
                    ...
                    <PlotSummary text={movie.summary}/>
            ...
            <PlotSynopsis text={movie.synopsis}/>
            <hr/>
            <ReviewingForm/>
            <hr/>
            <CommentsSection movieId={'41dad570130f4397af9cbd9a525c129a'}/>
        </div>
    </div>
